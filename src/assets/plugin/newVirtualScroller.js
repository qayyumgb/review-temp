...
var d33VirtualScroller = function () {
  var enter = null,
    update = null,
    exit = null,
    data = [],
  ...
  function virtualscroller(container) {
    ...
    function scrollRenderFrame(scrollPosition, scrollTop) {
      ...
      if (svgID == "TabRtnPA") { visibleRows = 16; } else { visibleRows = 10; }
      ...
      container.each(function () {                                                         // slice out visible rows from data and display
        ...
        var TotalData = {
          ...
          'TotalDataInf': ["-12", "0", "8", "12", "15", "15", "12", "8", "0", "-10", "-16", "-20"],
        ...
        if (svgID == "TabRtnPA") { getT_Data = ['14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14', '14'] }
        ...
        if (svgID == "TabRtnPA") {
          ...
          rowUpdateSelection.each(function (d, i) {
            if (selcompany != undefined) {
              if (i == 0) {
                if (selcompany.companyName == undefined) { this.classList.remove("gridselcomp"); }
                else if (d.companyName.toLowerCase() != selcompany.companyName.toLowerCase()) {  this.classList.remove("gridselcomp"); }
