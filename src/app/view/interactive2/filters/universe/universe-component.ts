...
@Component({
  selector: '[app-filter-universe]',
  standalone: false,
  templateUrl: './universe-component.html',
  styleUrl: './universe-component.scss'
})
export class FilterUniverseComponent implements OnInit{
  /** receive/send data **/
  ...
  ngOnInit() {
    ...
    var myData = this.MyData.forEach((item: any) => {
      ...
      item.size = Math.floor(Math.random() * (300 - 50 + 1)) + 50; // Random size between 50 and 500
    });
