...
@Component({
  selector: 'approved-common-error-dialog',
...
export class CommonErrorDialogComponent implements OnInit, OnDestroy {
  ...
  dialogData: any;
  dialogOptions: any;
  constructor(public sharedData: SharedDataService, private dirIndexService: DirectIndexService, private dialogref: MatDialogRef<CommonErrorDialogComponent>, @Inject(MAT_DIALOG_DATA) public modalData: any) {
  }
  ngOnInit() {
