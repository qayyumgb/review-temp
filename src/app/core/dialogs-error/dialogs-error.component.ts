...
@Component({
  ...
  styleUrl: './dialogs-error.component.css'
})
export class DialogsErrorComponent implements OnInit, OnDestroy{
  ...
  constructor(private dialogref: MatDialogRef<DialogsErrorComponent>, @Inject(MAT_DIALOG_DATA) public modalData: any,public sharedData: SharedDataService) {
  }
